...
void draw() {
  ...
  case 1:
    ...
    circle( 300, 200, 100 );  //mi boton para empezar la aventura
...
void mousePressed() {  //aca se programan los botones
  ...
  if ( estado == 0 && estoyDentroDeZonaCircular(300,400,50) ) {
    estado = 1;
  } else if ( estado == 1 && estoyDentroDeZonaCircular(300,200,50) ) {
    estado = 2;
  } else if ( estado == 2 ) {
