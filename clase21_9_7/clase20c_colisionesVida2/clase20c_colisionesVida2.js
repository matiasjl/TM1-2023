...
/* Cosas trabajadas:
  ...
  - "vida" u otros contadores que se siguen sumando indefinidamente: estragia #2 utilizar una variable booleana "colisiono"
...
function draw() {
  ...
  if( dist( x1, y1, x2, y2 ) < 100 && colisiono == false ){
    vida = vida - 1;
    colisiono = true;
  }
